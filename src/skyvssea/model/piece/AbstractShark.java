...
abstract class AbstractShark extends AbstractPiece {
	...
	protected AbstractShark(String name, Hierarchy level, Hierarchy attackLevel, Hierarchy defenceLevel, int moveRange,
							int attackRange, SpecialEffectCode specialEffectCode, int specialEffectCooldown) {
		super(name, level, attackLevel, defenceLevel, moveRange, MOVE_DIRECTION, attackRange, specialEffectCode, specialEffectCooldown);
	}
}