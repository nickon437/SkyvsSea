...
public class ColorUtil {
    ...
    public static final Color ACTIVATED_BUTTON_COLOR = Color.valueOf("#0f4a7f");//Color.valueOf("#f44336");
    public static final Color STANDARD_DISABLED_COLOR = Color.valueOf("#88c0f1");
